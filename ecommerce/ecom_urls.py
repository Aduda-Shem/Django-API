...
from ecommerce.views.authentication import LoginView
from ecommerce.views.customers import CustomerRegistrationAPIView
...
urlpatterns = [
    ...
    path('register', CustomerRegistrationAPIView.as_view(), name='registration'),
